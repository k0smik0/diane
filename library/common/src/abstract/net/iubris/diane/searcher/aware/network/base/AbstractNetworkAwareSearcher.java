...
public abstract class AbstractNetworkAwareSearcher<SearchState, SearchResult> implements NetworkAwareSearcher<SearchState,SearchResult> {
	...
	@Override
	public SearchState search(Void... params) throws NoNetworkException, NetworkStateException, NetworkAwareSearchException, SearchException {
		networkAware.isConnected();
		return doSearch();
	}
	
	protected abstract SearchState doSearch() throws NetworkStateException, NetworkAwareSearchException;
}
