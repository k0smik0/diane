...
public abstract class AbstractRoboSearchAsyncTask 
...
implements SearcherCallable<SearchResult> 
{
    ...
    protected AbstractRoboSearchAsyncTask(Context context) {
        super(context);
    }
    protected AbstractRoboSearchAsyncTask(Context context, Handler handler) {
        super(context,handler);
    }
    protected AbstractRoboSearchAsyncTask(Context context, Handler handler, Executor executor) {
        super(context, handler, executor);
    }
    protected AbstractRoboSearchAsyncTask(Context context, Executor executor) {
