...
public abstract class AbstractSearchAsyncTask 
...
implements SearcherCallable<SearchResult> 
{
    ...
    protected AbstractSearchAsyncTask(Context context) {
        super(context);
    }
    protected AbstractSearchAsyncTask(Context context, Handler handler) {
        super(context,handler);
    }
    protected AbstractSearchAsyncTask(Context context, Handler handler, Executor executor) {
        super(context, handler, executor);
    }
    protected AbstractSearchAsyncTask(Context context, Executor executor) {
