...
import net.iubris.diane.searcher.aware.location.LocationAwareObserverSearcher;
import net.iubris.diane.searcher.aware.location.exceptions.state.LocationNotNewerStateException;
import net.iubris.polaris.locator.Locator;
import net.iubris.polaris.locator.utils.LocationUtils;
import android.location.Location;
import android.util.Log;

public abstract class AbstractLocationAwareObserverUpdaterSearcher<State,Result> 
//implements LocationAwareSearcher<State,Result,Boolean>, LocationObserver, LocationUpdater
implements LocationAwareObserverSearcher<State, Result>
{
	...
	public AbstractLocationAwareObserverUpdaterSearcher(/*KLocator kLocator,*/
			Locator iLocator,
