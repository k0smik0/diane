...
import net.iubris.diane.searcher.aware.location.exceptions.search.LocationNullException;
...
public interface ByLocationSearcher<SearchState, SearchResult> extends Searcher<SearchState, SearchResult> {
	/**
	 * Perform a search using specified location as mandatory parameter
	 * @param location
	 * @return
	...
	/**
	 * Return result from search(Location location) method
	 * @return
	 */
	public SearchResult getSearchResultByLocation();
}
