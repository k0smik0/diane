...
public class DianeRoboSampleSearchAsyncTaskOnlyNetwork extends AbstractRoboSearchAsyncTask<DianeRoboSampleSearcher, Void, Void, String> {
	
	final private DianeRoboSampleSearcher dianeSampleSearcher;
	
//	private String result;
	@Inject
	public DianeRoboSampleSearchAsyncTaskOnlyNetwork(Context context, DianeRoboSampleSearcher dianeSampleController) {
		super(context);
