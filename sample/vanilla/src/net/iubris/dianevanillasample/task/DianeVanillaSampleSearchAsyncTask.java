...
public class DianeVanillaSampleSearchAsyncTask extends AbstractSearchAsyncTask<DianeRoboSampleSearcher, Void, Void, String> {
	
	final private DianeRoboSampleSearcher dianeSampleSearcher;
	
//	private String result;
	
	public DianeVanillaSampleSearchAsyncTask(Context context, DianeRoboSampleSearcher dianeSampleController) {
		super(context);
