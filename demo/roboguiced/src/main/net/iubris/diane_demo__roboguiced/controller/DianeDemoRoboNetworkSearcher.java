...
@Singleton
public class DianeDemoRoboNetworkSearcher extends AbstractNetworkAwareSearcher<Void,String> {
	...
	@Inject
	public DianeDemoRoboNetworkSearcher(DefaultCheckerStateNetworkAware networkAware,
