...
public class DianeDemoVanillaLocalizedSearcherNetworkAwareStrictChecking extends AbstractLocalizedSearcherNetworkAwareStrictChecking<String> {
	
	private String result;
	private final Context context;
	
	public DianeDemoVanillaLocalizedSearcherNetworkAwareStrictChecking(CheckerStateNetworkAware networkAware, Context context) {
		super(networkAware);
